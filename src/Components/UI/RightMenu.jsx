      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-y-5">
          <div className="flex flex-col gap-y-2 px-5 py-4 bg-wedgewood-900 w-full rounded-md">
            <div
              ...
              className={`text-center px-3 py-1 text-sm rounded-sm cursor-pointer transition-all duration-500 border ${
                isWeighted
                  ? "bg-wedgewood-600 text-wedgewood-100 border-wedgewood-100"
                  : `border-wedgewood-100 text-wedgewood-100`
              }`}
            >
              Weighted
            </div>
          ...
          <span className="text-sm">Algorithm</span>
            ...
            <button
              className="text-center px-3 py-1 text-sm rounded-sm cursor-pointer transition-all duration-100 border hover:bg-wedgewood-600  border-wedgewood-100 text-wedgewood-100"
              id="run-btn"
